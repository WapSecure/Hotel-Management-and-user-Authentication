       ...
       <img class="img-responsive" src="images/home_banner.jpg" style="width:100%; height:180px;">
        <nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="admin.php">Booking Admin</a></li>
                    <li><a href="http://localhost/hms3/login.php">Staff Admin</a></li>
                </ul>
                </ul>
        ...
        <div class="row" style="color: #ed9e21">
            <div class="col-md-12 well" >
              ...
              <p>Online hotel Management system are a popular method for managing and  booking hotel rooms. Travelers can book rooms on a computer by using online security to protect their privacy and financial information and by using several online travel agents to compare prices and facilities at different hotels</p>
              <br>
              ...
              <br>
              <p>Online hotelManagement system are also helpful for making last minute travel arrangements. Hotels may drop the price of a room if some rooms are still available. There are several websites that specialize in searches for deals on rooms.</p>
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-4 wellfix">
              ...
              Address : Open University of Nigeria<br>
              Mail : Admin@gmail.com <br>
            </div>
            <div class="col-md-4"></div>
            <div class="col-md-4 wellfix">
                <h4><strong>Developed By</strong></h4><hr>
                <a href="#"><img src="#" class="pro_pic">Student Name</a>
